...
/**
 * The original anonymous-viewer collection page. Behaviour and layout are
 * preserved exactly as they were before the authenticated rewrite — see
 * AuthenticatedCollectionPage for the logged-in experience.
 */
