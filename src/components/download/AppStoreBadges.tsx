  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      <div className={`flex items-center gap-4 flex-wrap ${className}`}>
        {/* Apple App Store */}
        <span className="inline-flex items-center gap-3 bg-white text-black px-5 py-2 rounded-xl transition-colors no-underline w-44 justify-center opacity-50 cursor-not-allowed pointer-events-none">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
