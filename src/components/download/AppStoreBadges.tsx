  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      <div className={`flex items-center gap-3 flex-nowrap ${className}`}>
        {/* Apple App Store */}
        <span className="inline-flex items-center gap-2 bg-white text-black px-4 py-2 rounded-xl transition-colors no-underline w-40 justify-center opacity-50 cursor-not-allowed pointer-events-none whitespace-nowrap">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          <div className="text-left">
            <div className="text-[10px] leading-tight opacity-70">
              {t("appStoreBadges.applePrefix")}
            </div>
            <div className="text-sm font-semibold leading-tight">
              {t("appStoreBadges.appleStore")}
            </div>
          </div>
        </span>
        ...
        <span className="inline-flex items-center gap-2 bg-white text-black px-4 py-2 rounded-xl transition-colors no-underline w-40 justify-center opacity-50 cursor-not-allowed pointer-events-none whitespace-nowrap">
          ...
          <div className="text-left">
            <div className="text-[10px] leading-tight opacity-70">
              {t("appStoreBadges.googlePrefix")}
            </div>
            <div className="text-sm font-semibold leading-tight">
              {t("appStoreBadges.googleStore")}
            </div>
          </div>
        </span>
      </div>
