...
const VideoAudioContext = createContext<VideoAudioContextValue | undefined>(undefined);
...
export function useVideoAudio(): VideoAudioContextValue {
  ...
  if (!ctx) throw new Error('useVideoAudio must be used within a VideoAudioProvider');
  return ctx;
}
